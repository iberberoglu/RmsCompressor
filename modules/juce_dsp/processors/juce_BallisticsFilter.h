...
public:
    ...
    */
    ...
    SampleType processSample (int channel, SampleType inputValue, float rmsLevel, bool peak, bool rms, double attackCo, double releaseCo);
...
private:
    //==============================================================================
    SampleType calculateLimitedCte (SampleType, double) const noexcept;

    //==============================================================================
    std::vector<SampleType> yold;
    double sampleRate = 44100.0, expFactorAttack = -0.142, expFactorRelease = -0.142;
    SampleType attackTime = 1.0, releaseTime = 100.0, cteAT = 0.0, cteRL = 0.0;
    LevelCalculationType levelType = LevelCalculationType::peak;
    SampleType attackCoefficient = -0.1, releaseCoefficient = -0.4;
};
